...
public class AuthorBook extends org.jooq.impl.TableImpl<catalog.angularjs.generated.tables.records.AuthorBookRecord> {
	...
	private static final long serialVersionUID = 781102274;
	 ...
	 */
	@Override
	public org.jooq.UniqueKey<catalog.angularjs.generated.tables.records.AuthorBookRecord> getPrimaryKey() {
	...
	public java.util.List<org.jooq.UniqueKey<catalog.angularjs.generated.tables.records.AuthorBookRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<catalog.angularjs.generated.tables.records.AuthorBookRecord>>asList(catalog.angularjs.generated.Keys.PK);
	}
	...
	public java.util.List<org.jooq.ForeignKey<catalog.angularjs.generated.tables.records.AuthorBookRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<catalog.angularjs.generated.tables.records.AuthorBookRecord, ?>>asList(catalog.angularjs.generated.Keys.AUTHOR_BOOK__FK_AUTHOR, catalog.angularjs.generated.Keys.AUTHOR_BOOK__FK_BOOK);
	}
