...
public class BookRecord extends UpdatableRecordImpl<BookRecord> implements Record5<Integer, String, String, String, Boolean> {

	private static final long serialVersionUID = -1844888948;
	...
	/**
	 * Setter for <code>public.book.status</code>.
	 */
	...
	/**
	 * Getter for <code>public.book.status</code>.
	 */
	 ...
	 */
	@Override
	public BookRecord values(Integer value1, String value2, String value3, String value4, Boolean value5) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public BookRecord(Integer idBook, String title, String shortDescription, String datePublish, Boolean status) {
		super(Book.BOOK);
